<template>
  <div class="cl-pay-checkout-page" v-if="order">
    <div class="container">
      <ClBread>
        <ClBreadItem to="/">首页</ClBreadItem>
        <ClBreadItem to="/cart">购物车</ClBreadItem>
        <ClBreadItem >填写订单</ClBreadItem>
      </ClBread>
    <div class="wrapper">
        <!-- 收货地址 -->
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <ClButton type="primary" @click="submitOrderFn">提交订单</ClButton>
        </div>
      </div>
    </div>
  </div>
