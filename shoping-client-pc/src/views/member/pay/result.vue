  ...
  <div class="cl-pay-page">
    <div class="container">
      <ClBread>
        ...
        <ClBreadItem>支付结果</ClBreadItem>
      </ClBread>
      <!-- 支付结果 -->
      <div class="pay-result">
        <span v-if="$route.query.payReult" class="iconfont icon-queren2 green"></span>
        <span v-else class="iconfont icon-shanchu red" ></span>
        <p class="tit">订单支付{{$route.query.payReult?'成功':'失败'}}</p>
