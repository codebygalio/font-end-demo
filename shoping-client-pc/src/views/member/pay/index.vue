<template>
  <div class="cl-pay-page">
    <div class="container">
      <ClBread>
        <ClBreadItem to="/">首页</ClBreadItem>
        <ClBreadItem to="/cart">购物车</ClBreadItem>
        <ClBreadItem>支付订单</ClBreadItem>
      </ClBread>
      <!-- 付款信息 -->
      <div class="pay-info" v-if="order">
        ...
        <div class="tip">
          <p>订单提交成功！请尽快完成支付。</p>
          <p v-if="order.countdown > 0">支付还剩 <span>{{timeText}}</span>, 超时后将取消订单</p>
          <p v-else>订单已经超时</p>
        </div>
        <div class="amount">
          <span>应付总额：</span>
      ...
      <div class="pay-type">
        ...
        <div class="item">
          ...
          <a @click="visibleDialog = true" class="btn alipay"  target="_blank" :href="payUrl"></a>
        </div>
        <div class="item">
          <p>支付方式</p>
        ...
        <ClDialog title="正在支付..." v-model:visible="visibleDialog">
      <div class="pay-wait">
...
import { ref } from 'vue'
import { baseURL } from '@/myconfig.js'
export default {
  name: 'ClPayPage',
  setup () {
