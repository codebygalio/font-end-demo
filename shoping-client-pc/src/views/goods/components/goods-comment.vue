  ...
  <div class="goods-comment">
    <div class="head" >
      ...
      <div class="tags">
        ...
        <div class="dd">
          <a @click="changeTag(i)"  href="javascript:;" v-for="(item,i) in commentInfo.tags" :key="item.title"  :class="{active:currentTagIndex===i}">{{item.title}}（{{item.tagCount}}）</a>
        </div>
      </div>
    </div>
    ...
    <ClPagination   v-if="total" @current-change="changePagerFn" :page-size="reqParams.pageSize" :current-page="reqParams.page"  />
  </div>
</template>
<script>
...
export default {
  ...
  setup () {
    ...
    // console.log('comment-goods=', goods.value)
    ...
    return { commentInfo, currentTagIndex, changeTag, reqParams, commentList, changeSort, formatNickname, formatSpecs, total, changePagerFn }
  }
}
</script>
