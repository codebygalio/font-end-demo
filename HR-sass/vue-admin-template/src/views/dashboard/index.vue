  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img :src="userInfo.staffPhoto" v-imageError="require('@/assets/common/bigUserHeader.png')">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ name }}|农业种植有限公司-{{ $store.state.user.userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
